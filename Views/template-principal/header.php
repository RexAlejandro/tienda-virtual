...
<head>
    ...
    <!--PAYPAL-->
    <script src="https://www.paypal.com/sdk/js?client-id=<?php echo CLIENT_ID; ?>&currency=<?php echo MONEDA; ?>" data-sdk-integration-source="button-factory"></script>
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:999999999.ravm@gmail.com">999999999.ravm@gmail.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:+52 1 81 1177 6506">+52 1 81 1177 6506</a>
                </div>
                <div>
                    <a class="text-light" href="https://www.facebook.com/rexalejandro.villanuevamoreno/" target="_blank" rel="sponsored"><i class="fab fa-facebook-f fa-sm fa-fw me-2"></i></a>
                    <a class="text-light" href="https://twitter.com/RexAlejandro00" target="_blank"><i class="fab fa-twitter fa-sm fa-fw me-2"></i></a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <?php if (!empty($_SESSION['correoCliente'])){?>
                        ...
                        <img class="img-thumbnail" src="<?php echo BASE_URL . 'assets/img/logo.jpeg' ?>" alt="-LOGO-Cliente" width="50">
                        </a>
                    <?php }else{?>
