        ...
        if (isset($_POST['nombre']) && isset($_POST['clave'])) {
            if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['clave'])) {
                ...
                if (empty($verificar)) {
                    ...
                    $mensaje = array('msg' => 'Ya hay una cuenta asociada ha este correo', 'icono' => 'warning');
                }
            }
    ...
    public function enviarCorreo()
    {
        if (isset($_POST['correo']) && isset($_POST['token'])) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('999999999.ravm@gmail.com', TITLE);
                $mail->addAddress($_POST['correo']);     //Add a recipient

                //Content
                $mail->isHTML(true);                                  //Set email format to HTML
                $mail->Subject = 'Mensaje de: ' . TITLE;
                $mail->Body    = 'Para verificar tu correo de click <a href = "' . BASE_URL . 'Clientes/verificarCorreo/' . $_POST['token'] . '">aqui</a>';
                $mail->AltBody = 'Gracias por tu preferencia';
